...
class VisionModel:
    ...
    def analyze_image(self, file_path: str) -> dict:
        ...
        event_example_1, event_example_2 = _event_examples("image")
        ...
        return _normalize_image_result(_extract_json(raw))
    ...
    def analyze_video_native(
        ...
        if transcript:
            event_example_1, event_example_2 = _event_examples("video")
